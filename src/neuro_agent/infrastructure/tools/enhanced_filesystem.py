"""Enhanced file system tools for neuro_agent.

Mirrors deep_agents_from_scratch/enhanced_file_tools.py.
...
def grep_files(
    ...
    search_files: list[tuple[str, str]] = list(files.items())
    if file_glob:
        search_files = [
